  ...
  $.ajax({
    ...
    success: function (resume) {
      console.log(resume);
		...
		document.getElementById("cv").value = resume.cv;
      ...
      $.ajax({
        ...
        success: function (academicList) {
          ...
          academicLength = academicList.length;
        ...
        success: function (activityList) {
          ...
          for (let i = 0; i < activityLength; i++) {
            ...
            document.getElementsByClassName("activity_start")[i].value =
              activityList[i].start;
            document.getElementsByClassName("activity_end")[i].value =
              activityList[i].end;
            document.getElementsByClassName("activity_holdby")[i].value =
              activityList[i].holdby;
            document.getElementsByClassName("activity_detail")[i].value =
              activityList[i].detail;
          }
        },
        error: function (error) {
          console.log(error);
      ...
      $.ajax({
        ...
        success: function (careerList) {
          ...
          careerLength = careerList.length;
          ...
          for (let i = 0; i < careerLength; i++) {
            ...
            document.getElementsByClassName("career_companyname")[i].value =
              careerList[i].companyname;
            document.getElementsByClassName("career_start")[i].value =
              careerList[i].start;
            document.getElementsByClassName("career_end")[i].value =
              careerList[i].end;
            document.getElementsByClassName("career_ranks")[i].value =
              careerList[i].ranks;
            document.getElementsByClassName("career_salary")[i].value =
              careerList[i].salary;
            document.getElementsByClassName("career_jobduty")[i].value =
              careerList[i].jobduty;
      ...
      $.ajax({
        ...
        success: function (certificateList) {
          ...
          certificateLength = certificateList.length;
		 
          for (let i = 0; i < certificateLength; i++) {
			console.log("certificate 반복문 실행됨?");
            ...
            document.getElementsByClassName("certificate_name")[i].value =
              certificateList[i].name;
            document.getElementsByClassName("certificate_achievedate")[
              i
            ].value = certificateList[i].achievedate;
            document.getElementsByClassName("certificate_grade")[i].value =
              certificateList[i].grade;
            document.getElementsByClassName("certificate_achievefrom")[
              i
            ].value = certificateList[i].achievefrom;
            document.getElementsByClassName("certificate_certificatenumber")[
              i
            ].value = certificateList[i].certificatenumber;
          }
        },
        error: function (error) {
          console.log(error);
      ...
      $.ajax({
        ...
        success: function (educationList) {
          educationLength = educationList.length;
      ...
      $.ajax({
        ...
        success: function (languagesList) {
          languagesLength = languagesList.length;
          ...
          for (let i = 0; i < languagesLength; i++) {
            ...
            if (languagesList[i].levelwriting == "novice") {
              ...
              document.getElementsByClassName("languages_languages")[i].value =
                languagesList[i].languages;
              document.getElementsByClassName("languages_test")[i].value =
                languagesList[i].test;
              document.getElementsByClassName("languages_score")[i].value =
                languagesList[i].score;
              document.getElementsByClassName("languages_certificatenumber")[
                i
              ].value = languagesList[i].certificatenumber;
      ...
      $.ajax({
        ...
        success: function (oeList) {
          ...
          for (let i = 0; i < oeLength; i++) {
            ...
            document.getElementsByClassName("oe_country")[i].value =
              oeList[i].country;
            document.getElementsByClassName("oe_start")[i].value =
              oeList[i].start;
            document.getElementsByClassName("oe_end")[i].value = oeList[i].end;
            document.getElementsByClassName("oe_detail")[i].value =
              oeList[i].detail;
          }
        },
        error: function (error) {},
      ...
      $.ajax({
        ...
        success: function (portfolioList) {
          portfolioLength = portfolioList.length;
          ...
          $.ajax({
            ...
            success: function (portfoliofileList) {
			  console.log(portfoliofileList);
              portfolioLength = portfoliofileList.length;
              for (let i = 0; i < portfolioLength; i++) {
				if(portfoliofileList[i] != null) {
                document.getElementsByClassName("portfoliofiles")[i].value =
                  portfoliofileList[i].oriname;
                  }
              }
            },
            error: function (error) {},
...
function deletecertificate(data) {
  document
    ...
    .removeChild(data.closest(".tablebody"));
  certificateLength--;
}
