...
public class CareerController {
	...
	public ResponseEntity<List<Career>> reviseData(@PathVariable("id") Long id,
			@RequestBody List<CareerDto> careerDtoList) {
		try {
	...
	@GetMapping("/get/{id}")
	public ResponseEntity<List<Career>> getCareers(@PathVariable("id") Long id) {
		try {
			Resume resume = this.resumeService.getResume(id);
